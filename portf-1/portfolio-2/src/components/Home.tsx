        ...
        <div className="nav">
            ...
            <div className="nav_menu">
                ...
                <div className="responsive-socals">
                    <a href="#" className="button menu-open w-button">Get in Touch</a>
                </div>
            </div>
            <div className="nav_social">
                <a href="#" className="button navbar_btn w-button">Get in Touch</a>
                    ...
                    <div  className="hero-visual_wall">
                        <div className="hero-visual">
                            ...
                            <div className="hero-visual_me">
                                <img src="https://i.ibb.co/Wv1YZL4N/4th.webp" loading="eager" sizes="(max-width: 991px) 100vw, 530px" srcSet="https://i.ibb.co/Wv1YZL4N/4th.webp 500w, https://i.ibb.co/Wv1YZL4N/4th.webp 800w, https://i.ibb.co/Wv1YZL4N/4th.webp 1080w, https://i.ibb.co/Wv1YZL4N/4th.webp 1400w" alt="" className="hero-visual_me-img before"/>
                                <div className="hero-visual_me-img after"></div>
                            </div>
                            <div className="hero-visual_transition-box">
                                <div data-is-ix2-target="1" className="hero-visual_transition" data-animation-type="lottie" data-src="https://cdn.prod.website-files.com/62c6f0db8f3bd1cd89369e11/6367e46643f4584666cc2c68_lf30_editor_wepwsxy3.json" data-loop="0" data-direction="1" data-autoplay="0" data-renderer="svg" data-default-duration="2.0020019204587935" data-duration="0"></div>
                            </div>
                        </div>
...
const Hero = () => {
  ...
  const pulseStrokeRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    const dots = pulseRef.current?.querySelectorAll('.tm_dot') || [];
    const strokeDots = pulseStrokeRef.current?.querySelectorAll('.tm_dot.stroke') || [];
        ...
        <div className="hero-content">
          <div className="hero-content_headline">
            ...
            <div className="hero_tm">
              ...
              <div className="tm" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} ref={containerRef}>
                <div className="tm_label">VG</div>
                <div className="tm_hover-circle" ref={circleRef}></div> {/* <- You need this for the animation to be visible */}
                
                <div className="tm_dot-box" ref={pulseRef}>
                    <div className="tm_dot _1"></div>
                    <div className="tm_dot _2"></div>
                    <div className="tm_dot _3"></div>
                </div>

                <div className="tm_dot-box stroke" ref={pulseStrokeRef}>
